...
export default function InputInfo(){
    ...
    return <>
        <div className="w-96 flex flex-col mx-auto mt-10 gap-6">
            ...
            <button className="bg-pink-800 font-semibold text-base text-white h-9 hover:bg-pink-700 mt-3 underline" onClick={nextHandler}>NEXT</button>
        </div>
    </>
}